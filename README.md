...
**1. `pi install` (권장)** — 자동 install/uninstall + settings.json 등록.
```bash
# npm 에 publish 된 경우
pi install npm:hmm-code-pi

# 또는 git 직접
pi install https://github.com/lbm1202/hmm-code-pi
pi install ssh://git@github.com/lbm1202/hmm-code-pi   # private repo
```

**2. git clone 수동 설치** — 직접 수정하면서 쓸 때.
```bash
mkdir -p ~/.pi/agent/extensions
git clone https://github.com/lbm1202/hmm-code-pi ~/.pi/agent/extensions/hmm-code-pi
```
...
```
~/.pi/agent/extensions/hmm-code-pi/
